...
Copy the Axway setup file (APIGateway_7.7.20230228_Install_linux-x86-64_BN01.run) and licence file in the project 'dist' directory
...
```
docker build --build-arg APIM_RUN_FILE=dist/APIGateway_7.7.20230228_Install_linux-x86-64_BN01.run --build-arg APIM_LIC_FILE=dist/licence.lic -t filter-devkit-docker -f src\main\docker\Dockerfile .
```
